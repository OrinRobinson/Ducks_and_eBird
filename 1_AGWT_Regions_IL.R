...
AGWT_eBird_R1 <-data.frame(week = date_to_st_week(parse_raster_dates(abd_crop)),
...
saveRDS(AGWT_eBird_R1, "AGWT_ILL_1.rds")
...
# could add additional masking here, e.g. if you had a county boundary
# mean cell value for each week within extent
AGWT_eBird_R2 <-data.frame(week = date_to_st_week(parse_raster_dates(abd_crop)),
                           abd = cellStats(abd_crop, mean),
                           lower = cellStats(low_crop, mean),
                           upper = cellStats(upp_crop, mean),
                           row.names = NULL)
...
saveRDS(AGWT_eBird_R2, "AGWT_ILL_2.rds")
...
# could add additional masking here, e.g. if you had a county boundary
# mean cell value for each week within extent
AGWT_eBird_R3 <-data.frame(week = date_to_st_week(parse_raster_dates(abd_crop)),
                           abd = cellStats(abd_crop, mean),
                           lower = cellStats(low_crop, mean),
                           upper = cellStats(upp_crop, mean),
                           row.names = NULL)
...
saveRDS(AGWT_eBird_R3, "AGWT_ILL_3.rds")
...
AGWT_eBird_R4_a <-data.frame(week = date_to_st_week(parse_raster_dates(abd_crop)),
                             abd = cellStats(abd_crop, mean),
                             lower = cellStats(low_crop, mean),
                             upper = cellStats(upp_crop, mean),
                             row.names = NULL)
...
AGWT_eBird_R4_b <-data.frame(week = date_to_st_week(parse_raster_dates(abd_crop)),
                             abd = cellStats(abd_crop, mean),
                             lower = cellStats(low_crop, mean),
                             upper = cellStats(upp_crop, mean),
                             row.names = NULL)
...
AGWT_eBird_R4 <- rbind(AGWT_eBird_R4_a, AGWT_eBird_R4_b) %>% 
  group_by(week) %>%
...
saveRDS(AGWT_eBird_R4, "AGWT_ILL_4.rds")
